...
Summoned Skeletts talk. They react to being raised, to picking a fight, to
...
you what a blow was made of, complain specifically about being on fire, admire
the weapon you just swung, and rib each other by name when nothing is happening.
...
the good version of each: a Skelett that praised every raised shield would be
...
Lines can also be attached to where the Skelett is standing, what time of day it
is, and whether you are safe at home. Write
...
parse leaves the Skeletts saying what they said a minute ago, and puts the
...
repeating it — five Skeletts all reacting to the same greydwarf would be an
...
In a shared world everybody with the mod sees everybody's Skeletts talk, and
there is nothing to install on a server to get it. A Skelett records what it
...
line itself, so you and your friends do not need matching files: your Skeletts
...
player and `{companion}` names another of your Skeletts, and both can go in any
